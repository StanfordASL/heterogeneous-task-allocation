...
% Flag to Store Video
flag_store_video = 1; % set to 1 if you want to store video
...
flag_type_task_allocation = 3; % 1 = Dumb Hurestic 1, 2 = Dumb Hurestic 2, 3 = Centralized Table II,

% Time Horizon Window
time_horizon = 6; % integer >= 0
...
if (flag_store_video == 1)
    myVideo1 = VideoWriter('video_v10.mp4', 'MPEG-4');
