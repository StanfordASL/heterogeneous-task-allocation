function [homo_reward, homo_x_sol, homo_z_sol] = func_homo_task_assignment(homo_T_f_tau,homo_num_agents,homo_agent_bin,total_grid_bins,time_horizon,grid_num_x,grid_num_y,threshold_max_distance)
