...
flag_type_task_allocation = 4; % 1 = Dumb Hurestic 1, 2 = Dumb Hurestic 2, 3 = Centralized Table II, 4 = Distributed PFSF, Centralized Homogeneous, 5 = Distributed PFSF, Distributed Homogeneous,
...
if (flag_store_video == 1)
    myVideo1 = VideoWriter('video_v11.mp4', 'MPEG-4');
