...
flag_type_task_allocation = 8; % 1: Dumb Heuristic , 2,6: Task Assignment (1 step) Section 4, 3,7: Task Assignment (multi-step homogenenous) Section 5.A, 4,8: Task Assignment (multi-step heterogeneous) Section 6.A,
